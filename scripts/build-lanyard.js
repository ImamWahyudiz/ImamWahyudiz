...
const photoB64 = fs.readFileSync(path.join(__dirname, '../public/foto-formal.b64'), 'utf8').trim();
...
const svgContent = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 400 620" width="400" height="620">
  <defs>
    <style>
      ...
      .specular-shine {
        animation: shine-sweep 10s cubic-bezier(0.4, 0.0, 0.2, 1) infinite;
      }
    ...
    <clipPath id="cardBounds">
      <rect x="55" y="125" width="290" height="470" rx="19" />
    </clipPath>
  </defs>
  ...
  <g class="lanyard-sway-group">
    ...
    <g class="front-card-rig">
      ...
      <text x="200" y="160" text-anchor="middle" font-size="10" fill="#00f2fe" letter-spacing="3" opacity="0.85" font-weight="700">DEV // PASS-2026</text>
      ...
      <text x="200" y="308" text-anchor="middle" font-size="12" font-weight="700" fill="#00f2fe" letter-spacing="1">FULL STACK &amp; IOT DEV</text>
      <text x="200" y="328" text-anchor="middle" font-size="11" fill="#94a3b8">&lt; STUDENT &amp; MAKER /&gt;</text>
      ...
      <g transform="translate(70, 395)">
        ...
        <g transform="translate(8, 6) scale(0.6)" fill="none" stroke="#61dafb" stroke-width="2">
          <ellipse cx="11" cy="11" rx="4" ry="10" transform="rotate(30 11 11)" />
          <ellipse cx="11" cy="11" rx="4" ry="10" transform="rotate(90 11 11)" />
          <ellipse cx="11" cy="11" rx="4" ry="10" transform="rotate(150 11 11)" />
          <circle cx="11" cy="11" r="2" fill="#61dafb" />
        </g>
        <text x="50" y="17" text-anchor="middle" font-size="10" fill="#38bdf8" font-weight="700">REACT</text>
      </g>

      <!-- 2. Laravel -->
      <g transform="translate(160, 395)">
        <rect x="0" y="0" width="80" height="26" rx="4" fill="#0f172a" stroke="#334155" stroke-width="1" />
        <path d="M 8 13 L 13 8 L 19 12 L 14 17 Z" fill="#f43f5e" transform="translate(4, 2) scale(0.7)" />
        <text x="50" y="17" text-anchor="middle" font-size="10" fill="#f43f5e" font-weight="700">LARAVEL</text>
      </g>
    ...
    <g clip-path="url(#cardBounds)" pointer-events="none">
      <rect x="0" y="125" width="200" height="470" fill="url(#shineGrad)" class="specular-shine" />
    </g>
...
fs.writeFileSync(path.join(__dirname, '../lanyard.svg'), svgContent);
console.log('Successfully written lanyard.svg with foto-formal to public/ and root!');
